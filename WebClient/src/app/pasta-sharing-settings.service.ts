...
export class PastaSharingSettingsService {
  ...
  addPastaSharingSettings(
    pastasharing: PastaSharingSettingsRequest
  ): Observable<void> {
  ...
  UpdatePastaSharingSettings(
    date: string,
    pastaGroupID: string | null
  ): Observable<void> {
    return this.httpClient.post<void>(
      this.startURL +
        '/update/' +
  ...
  getPastaSharingSettings(
    pastaBindID: string | null
  ): Observable<PastaSharingSettingsResponse[]> {
    return this.httpClient.get<PastaSharingSettingsResponse[]>(
      this.startURL + '/get/' + this.authservice.getUserID() + '/' + pastaBindID
    );
  }
}
